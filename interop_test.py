    ...
    async with connect(
        ...
        try:
            ...
            if stream_before_reset:
                client._quic._logger.info(f"Stream {stream_id} state before reset: send_buffer empty={stream_before_reset.sender.buffer_is_empty}, flow_control_blocked={stream_before_reset.sender.flow_control_blocked}, stream_ended={stream_before_reset.sender.stream_ended}")
