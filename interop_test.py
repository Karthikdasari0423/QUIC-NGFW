...
async def test_max_uni_streams_kdaquic(server: Server, configuration: QuicConfiguration):
    ...
    async with connect(
        ...
        max_uni_streams_server_limit = quic_conn._remote_max_streams_uni
        print(f"Server {server.name} advertised _remote_max_streams_uni: {max_uni_streams_server_limit}")
