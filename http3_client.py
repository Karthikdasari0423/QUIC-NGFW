...
class RetireCID(aioquic.quic.connection.QuicConnection,aioquic.quic.connection.QuicConnectionAdapter,logging.LoggerAdapter,QuicConnectionProtocol):
    def __init__(self, *args, **kwargs) -> None:
        super().__init__(*args, **kwargs)
    print("i am in class")
    ...
    def change_connection_id(self) -> None:
        ...
        if client._quic._peer_cid_available:
           ...
           # self._quic._retire_peer_cid(client._quic._peer_cid)
            ...
            self._retire_peer_cid(connection_id=pcid)
