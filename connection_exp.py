...
class QuicConnection:
    ...
    def __init__(
        ...
        *,
        ...
        print("self .host cid poped is ",self.host_cid)
        # self.host_cid = binascii.unhexlify("0011223344556677")
       ...
       #self._local_initial_source_connection_id = binascii.unhexlify("0011223344556677")

        print("self .host cid poped isself._local_initial_source_connection_id ",self._local_initial_source_connection_id)
        ...
        self._peer_cid = QuicConnectionId(
          ...
          # cid=binascii.unhexlify("0011223344556677"), sequence_number=None
        )
      # self._peer_cid = binascii.unhexlify("0011223344556677")
    ...
    def original_destination_connection_id(self) -> bytes:
        print("original_destination_connection_id is ",self._original_destination_connection_id)
    ...
    def change_connection_id(self) -> None:
        ...
        """
        print("self.host_cid is ",self.host_cid)
        print("self._host_cids is ",self._host_cids)
        print("self._local_initial_source_connection_id is ",self._local_initial_source_connection_id)
        
        if self._peer_cid_available:
            # retire previous CID
            print("new connection id is i mean before",self._peer_cid_available)
            print("type of self._peer_cid_available is",type(self._peer_cid_available))
            print("cid available is ",self._peer_cid_sequence_numbers)
            print("retired cid is",self._peer_cid)
            print("retired cid in peer cid is",self._peer_cid.cid)
           # print("QuicConnectionId.cid is ",QuicConnectionId.cid)
            self._retire_peer_cid(self._peer_cid)
           # self._peer_cid_available.clear()
           
            global rpsid
            rpsid = binascii.unhexlify("0011223344556677")

            val1 = QuicConnectionId(cid=rpsid, sequence_number=1, stateless_reset_token=os.urandom(16))#d_cid
          
            val3 = QuicConnectionId(cid=rpsid, sequence_number=1, stateless_reset_token=os.urandom(16),was_sent=True)#s_cid
            val2 = QuicConnectionId(cid=rpsid, sequence_number=2, stateless_reset_token=os.urandom(16))
            #self._peer_cid_available[0]=val1
            self._peer_cid_available[1]=val2
           # self._host_cids[1]=val3
            print("after my changes is",self._peer_cid_available)
           ...
           # class QuicConnectionId:
            ...
            #    srt=os.urandom(16)
             #   cid: bytes = rpsid
              ...
              #  stateless_reset_token: bytes = srt
              #  was_sent: bool = False
           # val1 = QuicConnectionId(sequence_number=1,stateless_reset_token=os.urandom(16))
           # val2 = QuicConnectionId(sequence_number=2, stateless_reset_token=os.urandom(16))
           # val3 = QuicConnectionId(sequence_number=3, stateless_reset_token=os.urandom(16))
           # val4 = QuicConnectionId(sequence_number=4, stateless_reset_token=os.urandom(16))
           # val5 = QuicConnectionId(sequence_number=5, stateless_reset_token=os.urandom(16))
           # val6 = QuicConnectionId(sequence_number=6, stateless_reset_token=os.urandom(16))
           # val7 = QuicConnectionId(sequence_number=7, stateless_reset_token=os.urandom(16))
           # self._peer_cid_available[1]=val1
           # self._peer_cid_available.append(val2)
           # self._peer_cid_available.append(val3)
           # self._peer_cid_available.append(val4)
           # self._peer_cid_available.append(val5)
           # self._peer_cid_available.append(val6)
           # self._peer_cid_available.append(val7)
           # print("after my changes is",self._peer_cid_available)

            # assign new CID
            self._consume_peer_cid()
            print("next cid is",self._consume_peer_cid())
    ...
    def get_next_available_stream_id(self, is_unidirectional=False) -> int:
        ...
        print("stream id isssssssssssssssssssssssssssssssss",stream_id)
    ...
    def reset_stream(self, stream_id: int, error_code: int) -> None:
        ...
        print("new stream from conn.py is ",stream)
    ...
    def _consume_peer_cid(self) -> None:
        ...
        """
       # self._peer_cid = b'\xe931\xff\xf9\r\x00\x86'
        self._peer_cid = self._peer_cid_available.pop(0)
        #self._peer_cid = self._peer_cid_available[0]
       # l1=list(self._peer_cid_available)
        #self._peer_cid = l1[0]
        print("self._peer_cid is actually ",self._peer_cid)
        self._logger.debug(
    ...
    def _get_or_create_stream_for_send(self, stream_id: int) -> QuicStream:
        ...
        print("my own created stream id is ",stream_id)
        print("my own created stream is ",stream)
        return stream
    ...
    def _on_retire_connection_id_delivery(
        ...
        if delivery != QuicDeliveryState.ACKED:
            ...
            print("retired id updated")
            print("retied connection id append is ",self._retire_connection_ids)
        else:
            print("retied connection id not append is ",self._retire_connection_ids)
    ...
    def _retire_peer_cid(self, connection_id: QuicConnectionId) -> None:
        ...
        print("elf._retire_connection_ids actually is ",self._retire_connection_ids)
